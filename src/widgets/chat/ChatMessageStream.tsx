...
import { ChatProcess, extractProcessText } from "~/widgets/chat/ChatProcess.js";
import { ChatMessageBubble } from "~/widgets/chat/ChatMessageBubble.js";
import { ChatTurnStop } from "~/widgets/chat/ChatTurnStop.js";
          ...
          {messages.map((message) => {
            ...
            return (
              <Fragment key={message.id}>
                ...
                <ChatTurnStop reason={completed?.stopReason ?? null} />
              </Fragment>
            );
          })}
