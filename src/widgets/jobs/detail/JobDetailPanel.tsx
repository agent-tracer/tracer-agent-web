import { formatAbsoluteHHmmss, formatDuration } from "~/widgets/jobs/lib/time.js";
import { useGuidance } from "tracerWeb/store";
import { EmptyHint, GuidanceText, Pill, ScrollArea, SectionLabel, StatusDot, Tabs, TabsContent, TabsList, TabsTrigger } from "tracerWeb/ui";
import { JobResultActions } from "~/widgets/jobs/result/JobResultActions.js";
import { JobTrajectory } from "~/widgets/jobs/trajectory/JobTrajectory.js";
import { JOB_KIND_LABEL, JOB_STATUS_LABEL, elapsedMs, readUsage, statusDotKind } from "~/widgets/jobs/lib/job-view.js";
import { job } from "tracerWeb/entities";

const { JOB_STATUS, useJobQuery } = job;
type JobDto = job.JobDto;
