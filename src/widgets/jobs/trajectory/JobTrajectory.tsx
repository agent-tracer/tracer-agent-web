...
import { Badge, EmptyHint, GuidanceText, Pill } from "tracerWeb/ui";
import { formatDuration } from "~/widgets/jobs/lib/time.js";
import { job } from "tracerWeb/entities";

const { isActiveJobStatus, useJobStepsQuery } = job;
type AiJobRecordedStep = job.AiJobRecordedStep;
