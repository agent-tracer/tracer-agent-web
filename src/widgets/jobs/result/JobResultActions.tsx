...
import { readTitleSuggestions } from "~/widgets/jobs/result/job-result.js";
import { job, task, taskCleanup } from "tracerWeb/entities";

const { JOB_KIND, JOB_STATUS } = job;
type JobDto = job.JobDto;
const { useUpdateTaskMutation } = task;
const { useAcceptCleanupSuggestionMutation, useDismissCleanupSuggestionMutation, useTaskCleanupSuggestionsQuery } = taskCleanup;
type CleanupSuggestion = taskCleanup.CleanupSuggestion;
