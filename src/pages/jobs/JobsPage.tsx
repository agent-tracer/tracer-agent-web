...
import { useNowMs } from "~/pages/jobs/use-now-ms.js";
import { useGuidance } from "tracerWeb/store";
import { Button, Card, EmptyHint, GuidanceText } from "tracerWeb/ui";
import { JobDetailPanel } from "~/widgets/jobs/detail/JobDetailPanel.js";
import { isJobKind, isJobStatus } from "~/widgets/jobs/lib/job-view.js";
import { JobFilters } from "~/widgets/jobs/list/JobFilters.js";
import { JobHistoryTable } from "~/widgets/jobs/list/JobHistoryTable.js";
import { job } from "tracerWeb/entities";

const { useJobsHistoryQuery } = job;
